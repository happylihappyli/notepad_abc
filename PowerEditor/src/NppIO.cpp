...
bool resolveLinkFile(std::wstring& linkFilePath)
{
	...
	const std::wstring lnkSuffix = L".LNK";
	if (linkFilePathUp.length() < lnkSuffix.length() || 
		linkFilePathUp.compare(linkFilePathUp.length() - lnkSuffix.length(), lnkSuffix.length(), lnkSuffix) != 0)
